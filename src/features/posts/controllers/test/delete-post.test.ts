...
describe('Delete', () => {
  ...
  it('should send correct json response', async () => {
    ...
    jest.spyOn(PostCache.prototype, 'deletePostsFromCache');
    ...
    expect(PostCache.prototype.deletePostsFromCache).toHaveBeenCalledWith(req.params.postId, `${req.currentUser?.userId}`);
